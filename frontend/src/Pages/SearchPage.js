  ...
  return (
    <>
      ...
      <div
        ...
        className="w[100%] min-h-[100vh] max-h-[100%] bg-gradient-to-b from-white to-gray-100 text-black  pt-[130px] md:pl-5 sm:pl-2 md:pt-[80px] pb-20"
      >
        <div className="ml-80 md:ml-5 sm:ml-1">
          ...
          <div className="mt-5 relative flex justify-start items-center">
            <div className="absolute top-4 xsm:top-2 left-3 text-xl text-black">
              <IoSearch />
            </div>
            <input
              onChange={(e) => setTopic(e.target.value)}
              className="w-[400px] sm:w-[290px] xsm:w-[230px] xsm:text-sm  py-2 pl-12 sm:pl-10 outline-none text-xl sm:text-lg text-black rounded-full bg-gradient-to-b from-white to-gray-100 text-black"
              type="text"
              placeholder="Title, Author or Keyword.."
            ></input>
            <button
              onClick={() => handleSearch("byInput")}
              className="w-[200px] sm:w-[130px] xsm:w-[100px] xsm:text-sm xsm:p-2 bg-slate-900 ml-2 rounded-3xl p-3 text-black text-lg"
            >
              Search
            </button>
          </div>
          ...
          <div className="flex justify-start items-center flex-wrap w-[70%] md:w-[100%] mt-5">
            {topics.map((topic, idx) => (
              <p
                ...
                key={idx}
                className="p-2 text-black rounded-lg m-1 bg-gradient-to-b from-white to-gray-100 text-black shadow-md cursor-pointer"
              >
                {topic}
              </p>
            ))}
