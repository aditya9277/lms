...
const RequestForm = () => {
  ...
  return (
    <>
      <Header />
      <div className="w[100%] h-[100%] flex md:flex-col-reverse justify-start items-center bg-gradient-to-b from-white to-gray-100 text-black pt-[130px] md:pl-5 sm:pl-0 md:pt-[80px] pb-20">
