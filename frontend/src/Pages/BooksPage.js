  ...
  return (
    <>
      ...
      <div
        ...
        className="w[100%] h-max bg-gradient-to-b from-white to-gray-100 text-black  pt-[130px] pl-20 md:pl-5 md:pt-[80px] pb-20"
      >
        <p
          style={{
          ...
          className="z-50 fixed top-24 left-0 p-2 pl-5 text-lg  ease-in-out duration-300 text-black shadow-lg border-[2px] border-emerald-900"
        >
