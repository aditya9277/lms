    ...
    <>
      ...
      <div className="h-[100vh] flex">
        <div
          ...
          className="absolute hidden sm:block top-16 right-0 bg-gradient-to-b from-white to-gray-100 text-black text-xl rounded-l-lg shadow-2xl font-extralight p-2"
        >
