...
const GetBookForm = ({ defaultDetail }) => {
  ...
  return (
    <div className="ml-64 md:ml-5 sm:ml-0 sm:mt-7 sm:w-[100%]">
      ...
      >
        <input
          className="bg-gradient-to-b from-white to-gray-100 text-black px-4 py-3 w-[400px] sm:w-[90%] mb-3 text-black rounded-2xl outline-none"
          type="text"
        ...
        <div className="flex justify-between items-center w-[400px] sm:w-[90%] mb-3">
          <div className="flex flex-col justify-center items-start">
            ...
            <input
              ...
              id="from"
              className="bg-gradient-to-b from-white to-gray-100 text-black px-4 py-3 sm:text-sm mt-1 w-[180px] sm:w-[160px] mb-3 text-black rounded-2xl outline-none"
              type="date"
              required
              min={min1}
            ></input>
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="bg-gradient-to-b from-white to-gray-100 text-black sm:text-sm px-4 py-3 mt-1 w-[180px] sm:w-[160px] mb-3 text-black rounded-2xl outline-none"
              type="date"
              required
              min={min2}
            ></input>
        ...
        <div className="relative">
          ...
          <input
            className="bg-gradient-to-b from-white to-gray-100 text-black px-10 py-3 w-[400px] sm:w-[90%] mb-3 text-black rounded-2xl outline-none"
            type="number"
            placeholder="Amount"
