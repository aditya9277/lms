  ...
  return (
    <div className="w-[95%] min-h-max max-h-[98%] overflow-x-scroll overflow-y-scroll scrollbar">
      <table className="w-[100%] border-collapse ">
        <thead>
          <tr className="sticky bg-gradient-to-b from-white to-gray-100  top-0 left-0 right-0 border-[1px] border-slate-200 text-black">
            {data?.map((data, idx) => {
              return (
                <th
                  key={idx}
          ...
          {reqData?.map((data, idx) => {
            return (
              <tr
                ...
                key={idx}
                className="bg-gradient-to-b from-white to-gray-100 text-black border-[1px] border-slate-200"
              >
