...
const SideBar = ({ dimension, status }) => {
  ...
  return (
    <div
      ...
      className="w-[20%] z-20 sm:w-[80%] ease-in-out duration-500 fixed top-0 left-0 bottom-0 pt-20 bg-gradient-to-b from-white to-gray-100 text-black  sm:-translate-x-[100%]"
    >
