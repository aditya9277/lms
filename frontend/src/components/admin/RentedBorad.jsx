  ...
  return (
    <div className="w-[95%] min-h-max max-h-[98%] overflow-x-scroll overflow-y-scroll scrollbar">
      <table className="w-[100%] border-collapse ">
        <thead>
          <tr className="sticky bg-gradient-to-b from-white to-gray-100 text-black  z-10  top-0 left-0 right-0 border-[1px] border-slate-200 text-black">
            {data?.map((data, idx) => {
              return (
                <th
                  key={idx}
          ...
          {rentalData?.map((data, idx) => {
            return (
              <tr
                ...
                key={idx}
                className="bg-gradient-to-b from-white to-gray-100 text-black text-black border-[1px] border-slate-200"
              >
                <td className="bg-fixed top-0  left-0 bottom- 0 bg-gradient-to-b from-white to-gray-100 text-black  p-3 text-center border-[0.5px] border-r-slate-400 w-[100%] whitespace-nowrap ">
                  {idx + 1}
                </td>
