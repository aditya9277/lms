...
const ProfileCard = () => {
  ...
  return (
    ...
    >
      <div
        onClick={closeToggle}
        className="hidden  md:block absolute top-0 right-0 bg-gradient-to-b from-white to-gray-100 text-black p-3 text-black rounded-tr-lg rounded-bl-md cursor-pointer"
      >
        <AiOutlineDown />
      </div>
